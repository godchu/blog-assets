...
const out = process.argv[3] || 'out.webp';

if (!url) {
  console.error('Usage: node apng2webp.mjs <apng-url> [out.webp]');
  process.exit(1);
}
...
console.log(`Saved ${out} (${n} frames, ${width}x${height}, delays=${delays.join(',')}ms)`);
